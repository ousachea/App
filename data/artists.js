...
export const DEFAULT_ARTISTS = [
 ...
 
  {
    ...
    url: '',  // Custom cover
    compilations: [''],
    mainWorks: ['SSIS-950','SONE-310','SONE-542','SONE-641','SONE-985']
  },
  {
    name: 'Alice',
    cover: '',
  ...
  },
  {
    ...
    url: '',  // Custom cover
    compilations: [''],
    mainWorks: ['VEC-749','BBTU-108','NACT-029','KAM-268','MVSD-657','JUR-345','MIDV-811','JUR-013','FWAY-016','NACT-007','420HHL-142']
  },
  {
    name: 'Mei Satsuki',
    cover: '',
  ...
  },
  {
    name: 'Aoi', cover: '',
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['SNIS-977']
  },
  {
    name: 'Asahi Mizuno', cover: '',
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['JUL-442', 'JUL-546', 'NITR-114']
  },
  {
    name: 'Asuna Kawai',
    cover: 'VENU-662',
  ...
  },
  {
    ...
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['ABP-433', 'ABP-447', 'ABP-460', 'ABP-471', 'ABP-484', 'BGN-031', 'CHN-096']
  },
  {
  ...
  },
  {
    ...
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['CKCK-020', 'EBWH-138', 'EBWH-191']
  },
  {
    name: 'Hikari Ogura', cover: '',
    url: '',  // Custom cover
  ...
  {
    name: 'Hoshino Nami', cover: '',
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['SNIS-373', 'SNIS-462']
  },
  {
    name: 'JULIA', cover: '',
    url: '',  // Custom cover
  ...
  {
    name: 'Marina Shiraishi', cover: '',
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['JUQ-941', 'JUL-225', 'STAR-830']
  },
  {
  ...
  },
  {
    name: 'Meguri', cover: '',
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['JUR-531', 'JUQ-943', 'PPPD-329']
  },
  {
    name: 'Mei Washio', cover: '',
    url: '',  // Custom cover
  ...
  {
    name: 'Miina Wakatsuki', cover: '',
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['AP-444','LUXU-856','LUXU-1047', 'CLUB-669', 'GVH-222', 'HUNTA-314', 'HUNTA-348', 'KATU-080', 'NGOD-113', 'NITR-202', 'SW-560', 'SW-621', 'NITR-209', 'FC2-PPV-1046522']
  },
  {
    name: 'Mina Fukuhara', cover: '',
    url: '',  // Custom cover
  ...
  },
  {
    ...
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['ADN-499', 'ADN-738', 'ATID-641', 'IPX-736', 'IPX-845', 'PRED-533', 'PRED-685']
  },
  {
  ...
  },
  {
    ...
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['300MIUM-892']
  },
  {
    name: 'Nagi Hikaru', cover: '',
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['SONE-385', 'SONE-290', 'SSIS-817', 'SONE-081', 'OFJE-558', 'SONE-340', 'SONE-097', 'SSIS-784', 'SSIS-426', 'SSIS-372', 'SIVR-144', 'SSIS-175', 'SSIS-139', 'SSIS-011', 'SSNI-961', 'SSIS-206']
  },
  {
    name: 'Nana Fukada', cover: '',
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['EBOD-578']
  },
  {
  ...
  },
  {
    ...
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['MIMK-263', 'SONE-394', 'SONE-486', 'SONE-532', 'SONE-748', 'SONE-837', 'SONE-888']
  },
  {
    name: 'Rion Hiiragi', cover: '',
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['259LUXU-1840', 'LUXU-1842']
  },
  {
  ...
  },
  {
    ...
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['ATOM-150','GANA-1026','IENE-596', 'IESP-605', 'JUFD-407', 'JUFD-502', 'NITR-056', 'PPPD-413', 'TYOD-255', 'VEC-094', 'VEC-135', 'WANZ-103']
  },
  {
  ...
  {
    name: 'Sakura Nene', cover: '',
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['DASD-406', 'HEYZO-3675', 'NITR-367', 'TEM-066','VGD-192']
  },
  {
    name: 'Satomi Hibino', cover: '',
    url: '',  // Custom cover
  ...
  },
  {
    ...
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['200GANA-2156', 'IND-063', 'IND-022', '483PAK-006', 'STCV-240', 'SUKE-062', 'MIUM-495', 'STCV-232', 'PAK-006', 'BONY-007', 'KTKC-074', 'NNPJ-514', 'NDH-017', 'MFC-169', 'MIUM-801', 'NTK-637', 'MFC-117', 'MAAN-842', 'MAAN-632', 'SIRO-3954']
  },
  {
    name: 'Sunao Kokonoi', cover: '',
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['REAL-958']
  },
  {
  ...
  },
  {
    ...
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['SNOS-009', 'SONE-590']
  },
  {
  ...
  },
  {
    ...
    url: '',  // Custom cover
    compilations: [''], mainWorks: ['BDA-059', 'JUFE-351', 'LULU-181', 'MILLE-009', 'PPPD-666', 'WANZ-388', 'JUR-126', 'BNST-056', 'ECB-109', 'BSY-022', 'VEC-340', 'XVSR-487', 'GES-038']
  }
];
