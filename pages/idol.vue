...
{ name: 'Hitomi Tanaka', mainWorks: [{ code: 'MIMK-007' }, { code: 'PPPD-663' }, { code: 'PPPD-867' }, { code: 'PPPD-996' }, { code: 'MDYD-940' }, { code: 'MDYD-971' }, { code: 'MIDE-184' }] },
{ name: 'Ai Sayama', mainWorks: [{ code: 'JUFE-101' }, { code: 'JUFE-090' }, { code: 'MEYD-652' }] },
{ name: 'Touka Rinne', mainWorks: [{ code: 'KTB-303' }, { code: 'PPPD-754' }, { code: 'MVSD-383' }, { code: 'JUY-603' }] },
{ name: 'Sakura Kirishima', mainWorks: [{ code: 'MKMP-001' }, { code: 'UMMA-001' }, { code: 'DVAJ-360' }, { code: 'FSET-797' }] },
{ name: 'Yuri Oshikawa', mainWorks: [{ code: 'PPPD-666' }, { code: 'JUFE-351' }, { code: 'MILLE-009' }, { code: 'LULU-181' }, { code: 'JUR-126' }, { code: 'WANZ-388' }, { code: 'BDA-059' }] },
{ name: 'Satomi Mioka', mainWorks: [{ code: 'BARE-009' }, { code: 'HAWA-325' }, { code: '300MIUM-908' }, { code: '300MIUM-865' }, { code: '483DAM-016' }, { code: 'MAAN-955' }, { code: 'APNS-293' }] },
{ name: 'Asahi Mizuno', mainWorks: [{ code: 'JUL-546' }, { code: 'JUL-442' }, { code: 'NITR-114' }] },
{ name: 'Miu Shiramine', mainWorks: [{ code: 'PRED-685' }, { code: 'ATID-641' }] },
{ name: 'Miina Wakatsuki', mainWorks: [{ code: 'NGOD-113' }, { code: 'SW-621' }, { code: 'NITR-202' }] },
{ name: 'Meguri', mainWorks: [{ code: 'JUR-531' }, { code: 'PPPD-329' }] },
{ name: 'Ai Kano', mainWorks: [{ code: 'JUQ-763' }, { code: 'JUQ-106' }, { code: 'JUQ-963' }] },
{ name: 'Koibuchi Momona', mainWorks: [{ code: 'START-165' }] },
{ name: 'Anna Morikawa', mainWorks: [{ code: 'PRED-018' }] },
{ name: 'Mary Tachibana', mainWorks: [{ code: 'ROYD-175' }, { code: 'NKKD-322' }] },
{ name: 'Marina Shiraishi', mainWorks: [{ code: 'STAR-830' }, { code: 'JUQ-941' }] },
{ name: 'Hikari Sena', mainWorks: [{ code: 'BNST-023' }, { code: 'WAAA-043' }, { code: 'URKK-035' }] },
{ name: 'Saeko Matsushita', mainWorks: [{ code: 'SHKD-713' }] },
{ name: 'Mio Kimijima', mainWorks: [{ code: 'JUY-606' }, { code: 'NITR-388' }, { code: 'JUY-543' }] },
{ name: 'Kanno Sayuki', mainWorks: [{ code: 'GVG-122' }] },
{ name: 'Ruri Saijo', mainWorks: [{ code: 'PPPD-413' }, { code: 'VEC-094' }, { code: 'WANZ-103' }, { code: 'IENE-596' }, { code: 'TYOD-255' }] },
...
{ name: 'Aiko Kimura', mainWorks: [{ code: 'SONE-866' }, { code: 'SONE-828' }] },
{ name: 'Saegusa Chitose', mainWorks: [{ code: 'NGOD-150' }] },
{ name: 'Mina Fukuhara', mainWorks: [{ code: 'CLUB-881' }] },
{ name: 'Aika Yumeno', mainWorks: [{ code: 'SONE-874' }, { code: 'SNIS-413' }, { code: 'SNIS-477' }, { code: 'SSNI-304' }, { code: 'SNIS-659' }] },
{ name: 'Sena Kasumi', mainWorks: [{ code: '483PAK-006' }, { code: '200GANA-2156' }] },
{ name: 'Aoi', mainWorks: [{ code: 'SNIS-977' }] },
{ name: 'Nanami Matsumoto', mainWorks: [{ code: 'OFES-009' }, { code: 'SSNI-110' }, { code: 'JUY-858' }] },
...
{ name: 'Ema Yuina', mainWorks: [{ code: 'CHN-096' }, { code: 'BGN-031' }, { code: 'ABP-433' }, { code: 'ABP-471' }, { code: 'ABP-447' }, { code: 'ABP-460' }, { code: 'ABP-484' }] },
