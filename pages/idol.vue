...
const DEFAULT_ARTISTS = [
  ...
  { name: 'Sakura Kirishima', mainWorks: [{ code: 'MKMP-001' }, { code: 'UMMA-001' }] },
  { name: 'Yuri Oshikawa', mainWorks: [{ code: 'PPPD-666' }] },
  { name: 'Satomi Mioka', mainWorks: [{ code: 'BARE-009' }, { code: 'HAWA-325' }, { code: '300MIUM-908' }] },
  ...
  { name: 'Ai Kano', mainWorks: [{ code: 'JUQ-763' }, { code: 'JUQ-106' }] },
  { name: 'Koibuchi Momona', mainWorks: [{ code: 'START-168' }] },
  { name: 'Anna Morikawa', mainWorks: [{ code: 'PRED-018' }] },
  { name: 'Mary Tachibana', mainWorks: [{ code: 'ROYD-175' }] },
  { name: 'Kokona Asakura', mainWorks: [{ code: 'ALDN-396' }, { code: 'BKYN-005' }] },
  { name: 'Marina Shiraishi', mainWorks: [{ code: 'STAR-830' }] },
  { name: 'Aika Yumeno', mainWorks: [{ code: 'SONE-874' }, { code: 'SNIS-413' }] },
  { name: 'Hikari Sena', mainWorks: [{ code: 'BNST-023' }, { code: 'WAAA-043' }, { code: 'URKK-035' }] },
  { name: 'Saeko Matsushita', mainWorks: [{ code: 'SHKD-713' }] },
  { name: 'Mio Kimijima', mainWorks: [{ code: 'JUY-606' }] },
